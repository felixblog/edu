...
a) Semplifica le seguenti espressioni tra monomi.
...
b) Semplifica le seguenti espressioni letterali.

1.  $ab\left(-\dfrac{1}{2}\right)a^{2} \cdot \dfrac{2}{5a^2}\dfrac{3}{b}$;   $abcde \cdot \dfrac{5}{ace}$;
2. $\dfrac{5}{3}b\left(-4\right)a : \dfrac{ab^2x}{3}$;   $a + 2a^2 \cdot \dfrac{2}{3a^2}$.

#### Laboratorio GEOGEBRA

a) Risolvi il punto a.1) esercizio con l'istruzione GEOGEBRA:  $a: a^{2}x\,\cdotp\left(\dfrac{1}{2}x\right)+\left(\dfrac{1}{2}ax\right)\,\cdotp\left(\dfrac{3}{2}a\right)-\dfrac{2}{3}a^{2}x^{2}$  &#9166; 
